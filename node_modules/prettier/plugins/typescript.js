(function(f){function e(){var i=f();return i.default||i}if(typeof exports=="object"&&typeof module=="object")module.exports=e();else if(typeof define=="function"&&define.amd)define(e);else{var t=typeof globalThis<"u"?globalThis:typeof global<"u"?global:typeof self<"u"?self:this||{};t.prettierPlugins=t.prettierPlugins||{},t.prettierPlugins.typescript=e()}})(function(){"use strict";var Xc=Object.defineProperty;var hy=Object.getOwnPropertyDescriptor;var yy=Object.getOwnPropertyNames;var gy=Object.prototype.hasOwnProperty;var jd=e=>{throw TypeError(e)};var by=(e,t,a)=>t in e?Xc(e,t,{enumerable:!0,configurable:!0,writable:!0,value:a}):e[t]=a;var Ld=(e,t)=>{for(var a in t)Xc(e,a,{get:t[a],enumerable:!0})},vy=(e,t,a,o)=>{if(t&&typeof t=="object"||typeof t=="function")for(let h of yy(t))!gy.call(e,h)&&h!==a&&Xc(e,h,{get:()=>t[h],enumerable:!(o=hy(t,h))||o.enumerable});return e};var xy=e=>vy(Xc({},"__esModule",{value:!0}),e);var Ma=(e,t,a)=>by(e,typeof t!="symbol"?t+"":t,a),Ty=(e,t,a)=>t.has(e)||jd("Cannot "+a);var Rd=(e,t,a)=>t.has(e)?jd("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,a);var we=(e,t,a)=>(Ty(e,t,"access private method"),a);var N3={};Ld(N3,{parsers:()=>Nd});var Nd={};Ld(Nd,{typescript:()=>P3});var Sy=()=>()=>{},Ja=Sy;var Bm="5.5";var Ot=[],wy=new Map;function ms(e){return e?e.length:0}function zn(e,t){if(e)for(let a=0;a<e.length;a++){let o=t(e[a],a);if(o)return o}}function ky(e,t){if(e!==void 0)for(let a=0;a<e.length;a++){let o=t(e[a],a);if(o!==void 0)return o}}function Ud(e,t,a){let o=[];B.assertEqual(e.length,t.length);for(let h=0;h<e.length;h++)o.push(a(e[h],t[h],h));return o}function lf(e,t){if(e){for(let a=0;a<e.length;a++)if(!t(e[a],a))return!1}return!0}function qm(e,t,a){if(e!==void 0)for(let o=a??0;o<e.length;o++){let h=e[o];if(t(h,o))return h}}function Jp(e,t,a){if(e===void 0)return-1;for(let o=a??0;o<e.length;o++)if(t(e[o],o))return o;return-1}function Ey(e,t,a=ff){if(e){for(let o of e)if(a(o,t))return!0}return!1}function Ay(e,t,a=ff){return e.length===t.length&&e.every((o,h)=>a(o,t[h]))}function Kr(e,t){if(e){let a=e.length,o=0;for(;o<a&&t(e[o]);)o++;if(o<a){let h=e.slice(0,o);for(o++;o<a;){let g=e[o];t(g)&&h.push(g),o++}return h}}return e}function Yp(e,t){let a;if(e){a=[];for(let o=0;o<e.length;o++)a.push(t(e[o],o))}return a}function zm(e){let t=[];for(let a of e)a&&(Zr(a)?Pn(t,a):t.push(a));return t}function Fm(e,t){let a;if(e)for(let o=0;o<e.length;o++){let h=t(e[o],o);h&&(Zr(h)?a=Pn(a,h):a=Cn(a,h))}return a||Ot}function Cy(e,t){let a;if(e)for(let o=0;o<e.length;o++){let h=e[o],g=t(h,o);(a||h!==g||Zr(g))&&(a||(a=e.slice(0,o)),Zr(g)?Pn(a,g):a.push(g))}return a||e}function Dy(e,t){let a=[];if(e)for(let o=0;o<e.length;o++){let h=t(e[o],o);h!==void 0&&a.push(h)}return a}function qt(e,t){if(e)if(t){for(let a of e)if(t(a))return!0}else return e.length>0;return!1}function uf(e,t){return qt(t)?qt(e)?[...e,...t]:t:e}function Py(e,t){return t}function Ny(e){return e.map(Py)}function Cn(e,t){return t===void 0?e:e===void 0?[t]:(e.push(t),e)}function Hp(e,t){return t<0?e.length+t:t}function Pn(e,t,a,o){if(t===void 0||t.length===0)return e;if(e===void 0)return t.slice(a,o);a=a===void 0?0:Hp(t,a),o=o===void 0?t.length:Hp(t,o);for(let h=a;h<o&&h<t.length;h++)t[h]!==void 0&&e.push(t[h]);return e}function Iy(e,t,a){return Ey(e,t,a)?!1:(e.push(t),!0)}function Oy(e,t,a){return e?(Iy(e,t,a),e):[t]}function My(e,t,a){t.sort((o,h)=>a(e[o],e[h])||mf(o,h))}function Jy(e,t){let a=Ny(e);return My(e,a,t),a.map(o=>e[o])}var M3=Array.prototype.at?(e,t)=>e==null?void 0:e.at(t):(e,t)=>{if(e&&(t=Hp(e,t),t<e.length))return e[t]};function pf(e){return e===void 0||e.length===0?void 0:e[0]}function Ki(e){return e===void 0||e.length===0?void 0:e[e.length-1]}function jy(e){return B.assert(e.length!==0),e[e.length-1]}function Ly(e){return e&&e.length===1?e[0]:void 0}function Ry(e,t,a,o,h){return Uy(e,a(t),a,o,h)}function Uy(e,t,a,o,h){if(!qt(e))return-1;let g=h||0,E=e.length-1;for(;g<=E;){let C=g+(E-g>>1),l=a(e[C],C);switch(o(l,t)){case-1:g=C+1;break;case 0:return C;case 1:E=C-1;break}}return~g}function By(e,t,a,o,h){if(e&&e.length>0){let g=e.length;if(g>0){let E=o===void 0||o<0?0:o,C=h===void 0||E+h>g-1?g-1:E+h,l;for(arguments.length<=2?(l=e[E],E++):l=a;E<=C;)l=t(l,e[E],E),E++;return l}}return a}var Vm=Object.prototype.hasOwnProperty;function Mr(e,t){return Vm.call(e,t)}function qy(e){let t=[];for(let a in e)Vm.call(e,a)&&t.push(a);return t}function zy(){let e=new Map;return e.add=Fy,e.remove=Vy,e}function Fy(e,t){let a=this.get(e);return a?a.push(t):this.set(e,a=[t]),a}function Vy(e,t){let a=this.get(e);a&&(Ky(a,t),a.length||this.delete(e))}function Zr(e){return Array.isArray(e)}function jp(e){return Zr(e)?e:[e]}function Wy(e,t){return e!==void 0&&t(e)?e:void 0}function Ir(e,t){return e!==void 0&&t(e)?e:B.fail(`Invalid cast. The supplied value ${e} did not pass the test '${B.getFunctionName(t)}'.`)}function Ga(e){}function Gy(){return!0}function kt(e){return e}function Bd(e){let t;return()=>(e&&(t=e(),e=void 0),t)}function tr(e){let t=new Map;return a=>{let o=`${typeof a}:${a}`,h=t.get(o);return h===void 0&&!t.has(o)&&(h=e(a),t.set(o,h)),h}}function ff(e,t){return e===t}function df(e,t){return e===t||e!==void 0&&t!==void 0&&e.toUpperCase()===t.toUpperCase()}function Yy(e,t){return ff(e,t)}function Hy(e,t){return e===t?0:e===void 0?-1:t===void 0?1:e<t?-1:1}function mf(e,t){return Hy(e,t)}function rl(e,t,a){let o=Math.max(2,Math.floor(e.length*.34)),h=Math.floor(e.length*.4)+1,g;for(let E of t){let C=a(E);if(C!==void 0&&Math.abs(C.length-e.length)<=o){if(C===e||C.length<3&&C.toLowerCase()!==e.toLowerCase())continue;let l=Xy(e,C,h-.1);if(l===void 0)continue;B.assert(l<h),h=l,g=E}}return g}function Xy(e,t,a){let o=new Array(t.length+1),h=new Array(t.length+1),g=a+.01;for(let C=0;C<=t.length;C++)o[C]=C;for(let C=1;C<=e.length;C++){let l=e.charCodeAt(C-1),Z=Math.ceil(C>a?C-a:1),f=Math.floor(t.length>a+C?a+C:t.length);h[0]=C;let k=C;for(let w=1;w<Z;w++)h[w]=g;for(let w=Z;w<=f;w++){let J=e[C-1].toLowerCase()===t[w-1].toLowerCase()?o[w-1]+.1:o[w-1]+2,re=l===t.charCodeAt(w-1)?o[w-1]:Math.min(o[w]+1,h[w-1]+1,J);h[w]=re,k=Math.min(k,re)}for(let w=f+1;w<=t.length;w++)h[w]=g;if(k>a)return;let v=o;o=h,h=v}let E=o[t.length];return E>a?void 0:E}function $y(e,t,a){let o=e.length-t.length;return o>=0&&(a?df(e.slice(o),t):e.indexOf(t,o)===o)}function Qy(e,t){e[t]=e[e.length-1],e.pop()}function Ky(e,t){return Zy(e,a=>a===t)}function Zy(e,t){for(let a=0;a<e.length;a++)if(t(e[a]))return Qy(e,a),!0;return!1}function cl(e,t,a){return a?df(e.slice(0,t.length),t):e.lastIndexOf(t,0)===0}function Xp(e){return e===void 0?void 0:[e]}var B;(e=>{let t=0;e.currentLogLevel=2,e.isDebugging=!1;function a(j){return e.currentLogLevel<=j}e.shouldLog=a;function o(j,se){e.loggingHost&&a(j)&&e.loggingHost.log(j,se)}function h(j){o(3,j)}e.log=h,(j=>{function se(Ke){o(1,Ke)}j.error=se;function fe(Ke){o(2,Ke)}j.warn=fe;function xe(Ke){o(3,Ke)}j.log=xe;function Xe(Ke){o(4,Ke)}j.trace=Xe})(h=e.log||(e.log={}));let g={};function E(){return t}e.getAssertionLevel=E;function C(j){let se=t;if(t=j,j>se)for(let fe of qy(g)){let xe=g[fe];xe!==void 0&&e[fe]!==xe.assertion&&j>=xe.level&&(e[fe]=xe,g[fe]=void 0)}}e.setAssertionLevel=C;function l(j){return t>=j}e.shouldAssert=l;function Z(j,se){return l(j)?!0:(g[se]={level:j,assertion:e[se]},e[se]=Ga,!1)}function f(j,se){debugger;let fe=new Error(j?`Debug Failure. ${j}`:"Debug Failure.");throw Error.captureStackTrace&&Error.captureStackTrace(fe,se||f),fe}e.fail=f;function k(j,se,fe){return f(`${se||"Unexpected node."}\r
Node ${Mt(j.kind)} was unexpected.`,fe||k)}e.failBadSyntaxKind=k;function v(j,se,fe,xe){j||(se=se?`False expression: ${se}`:"False expression.",fe&&(se+=`\r
