...
def test_radius_values(cif_URhIn):
    ...
    DeepDiff(actual_values, expected_values, significant_digits=3)
...
def test_radius_sum_data(cif_URhIn):
    ...
    print(actual_sum)
    {'CIF_radius_sum': {'In-In': 3.248, 'In-Rh': 2.969, 'In-U': 3.001, 'Rh-Rh': 2.69, 'Rh-U': 2.722, 'U-U': 2.754}, 'CIF_radius_refined_sum': {'In-In': 3.194, 'In-Rh': 2.697, 'In-U': 3.21, 'Rh-Rh': 2.2, 'Rh-U': 2.713, 'U-U': 3.226}, 'Pauling_radius_sum': {'In-In': 3.32, 'In-Rh': 3.002, 'In-U': 3.176, 'Rh-Rh': 2.684, 'Rh-U': 2.858, 'U-U': 3.032}}
    diff = DeepDiff(
        actual_sum,
        expected_sum,
...
#     assert cif.radius_sum == False
#     assert cif.radius_values == False
