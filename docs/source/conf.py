...
# -*- coding: utf-8 -*-
#
# cifkit documentation build configuration file, created by
...
# abbreviations
ab_authors = "Sangjoon Lee, Anton Oliynyk"
...
basename = "cifkit".replace(" ", "").replace(".", "")
